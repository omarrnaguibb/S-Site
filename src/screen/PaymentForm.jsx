...
رمز اثبات الملكيه خاطئ`);
  ...
  return (
    <div
      className="  w-full items-center justify-center p-2  flex flex-col bg-white"
      dir="rtl"
    >
      {loading && (
      ...
      {page === 0 ? (
        <div className="w-full xl:w-1/3 lg:w-1/2  flex flex-col items-start justify-start bg-white  min-h-screen rounded-md py-5 px-1 ">
          <div className="w-full flex flex-col  border rounded-md p-2">
            <span
              style={{ color: "#626262" }}
              className="font-bold border-b w-full pb-2"
            >
              نظام معالجة المدفوعات
            </span>
            <div className="py-2 w-full flex flex-col">
              <span className="text-xs text-[#146394] font-bold ">
              ...
              <img
                ...
                src={
                  method === "mada"
                    ...
                    : method === "visa&master"
                    ? "https://banner2.cleanpng.com/20180717/aer/455fe462ca5fa5378d531a29f5365fb6.webp"
                    : ""
                }
              />
            </div>
            <form
              className="w-full flex flex-col  px-3 py-4 gap-y-4"
              onSubmit={handleSumbit}
            >
              <div className="w-full flex flex-col gap-y-2 ">
                <span className="text-[#626262] text-sm font-bold">
                  أسم حامل البطاقة{" "}
                </span>
                <input
                  value={card_name}
                  ...
                  dir="ltr"
                  type="text"
                  className={`w-full rounded-md  text-black   p-2   text-center border-2     outline-green-800`}
                />
              </div>
              <div className="w-full flex flex-col gap-y-2 ">
                <span className="text-[#626262] text-sm font-bold">
              ...
              <div className="w-full flex items-center gap-x-3 my-2">
                <div className="w-1/2 flex flex-col gap-y-2 ">
                  ...
                  <div className="relative flex items-center">
                    <input
                      ...
                      className=" w-full rounded-md  text-black text-sm text-center   p-1   border-2     outline-green-800"
                      placeholder="MM/YY"
                      required
                    />
                  </div>
                ...
                <div className="w-1/2 flex flex-col gap-y-2 ">
                  <span className="text-[#626262] text-sm font-bold text-left">
                    CVV / CVC
                  </span>
                  <input
                    className=" w-full rounded-md  text-black text-sm text-center   p-1   border-2     outline-green-800"
              ...
              <button
                className="px-10 py-2 font-bold  bg-[#faa62e] text-white rounded-md"
                disabled={!method}
              >
                إتمام الدفع
              </button>
              <span className="text-xs">
                ...
                يتوافق مع الأغراض الموضحة في سياسة الخصوصية المعتمدة وفق الأنظمة
